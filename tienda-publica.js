...
@media (min-width: 900px) {
  ...
  .tnd-banner-slide img { aspect-ratio:auto; height:230px; width:100%; object-fit:contain; object-position:center; display:block; background:linear-gradient(135deg,#5B21B6,#7C3AED); border-radius:14px; }
}
